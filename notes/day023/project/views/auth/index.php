                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="auth.php" method="post" autocomplete="on">
                                ...
                                <p> 
                                    ...
                                    <input id="username" name="emailsignup" required="required" type="text" placeholder="myusername or mymail@mail.com"/>
                                </p>
                                <p> 
                        ...
                        <div id="register" class="animate form">
							...
							<p style="font-size: 20px; color: red;"> <?php if(isset($_SESSION['msg'])){ echo $_SESSION['msg'] ; unset($_SESSION['msg']);   } ?>  <p>        <input type="submit" value="Sign up"/>
								</p>
                                <p class="change_link">  
									Already a member ?
